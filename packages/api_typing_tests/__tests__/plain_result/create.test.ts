...
test('PlainResult::createOk', (t) => {
    ...
    t.true(expectTypeOf(actual).toExtend<PlainResult.Result<number, unknown>>());
    t.true(expectTypeOf(actual).toExtend<PlainResult.Result<number, never>>());
});
...
test('PlainResult::createErr', (t) => {
    ...
    t.true(expectTypeOf(actual).toExtend<PlainResult.Result<unknown, number>>());
    t.true(expectTypeOf(actual).toExtend<PlainResult.Result<never, number>>());
});
