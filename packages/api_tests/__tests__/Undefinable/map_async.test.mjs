...
import { mapAsyncForUndefinable } from 'option-t/__dist/esm/Undefinable/mapAsync.js';
...
test('callback should return Promise', async (t) => {
    ...
    await t.throwsAsync(
        async () => {
            await mapAsyncForUndefinable(NULLY_VALUE_BUT_NOT_NULL_VALUE_IN_THIS_TEST_CASE, () => {
                t.pass();
                return 1;
            });
        },
