...
export const apiTable = Object.freeze({
    ...
    'Maybe/namespace': pathRedirectionTo(`${MAYBE_DIR}/ns`),
    ...
    'Nullable/namespace': pathRedirectionTo(`${NULLABLE_DIR}/ns`),
    ...
    'PlainOption/namespace': pathRedirectionTo(`${PLAIN_OPTION_DIR}/ns`),
    ...
    'PlainResult/namespace': pathRedirectionTo(`${PLAIN_RESULT_DIR}/ns`),
    ...
    'Undefinable/namespace': pathRedirectionTo(`${UNDEFINABLE_DIR}/ns`),
