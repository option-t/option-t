...
export const apiTable = Object.freeze({
    ...
    'Maybe/compat/v33': pathRedirectionTo(`${MAYBE_DIR}/compat/v33`),
    'Maybe/expect': pathRedirectionTo(`${MAYBE_DIR}/expect`),
    ...
    'Maybe/unwrap': pathRedirectionTo(`${MAYBE_DIR}/unwrap`),
    ...
    'Nullable/compat/v33': pathRedirectionTo(`${NULLABLE_DIR}/compat/v33`),
    'Nullable/expect': pathRedirectionTo(`${NULLABLE_DIR}/expect`),
    ...
    'Nullable/unwrap': pathRedirectionTo(`${NULLABLE_DIR}/unwrap`),
    ...
    'PlainOption/compat/v33': pathRedirectionTo(`${PLAIN_OPTION_DIR}/compat/v33`),
    'PlainOption/drop': pathRedirectionTo(`${PLAIN_OPTION_DIR}/drop`),
    'PlainOption/equal': pathRedirectionTo(`${PLAIN_OPTION_DIR}/equal`),
    'PlainOption/expect': pathRedirectionTo(`${PLAIN_OPTION_DIR}/expect`),
    ...
    'PlainOption/unwrap': pathRedirectionTo(`${PLAIN_OPTION_DIR}/unwrap`),
    ...
    'PlainResult/compat/v33': pathRedirectionTo(`${PLAIN_RESULT_DIR}/compat/v33`),
    'PlainResult/drop': pathRedirectionTo(`${PLAIN_RESULT_DIR}/drop`),
    'PlainResult/equal': pathRedirectionTo(`${PLAIN_RESULT_DIR}/equal`),
    'PlainResult/expect': pathRedirectionTo(`${PLAIN_RESULT_DIR}/expect`),
    ...
    'PlainResult/unwrap': pathRedirectionTo(`${PLAIN_RESULT_DIR}/unwrap`),
    ...
    'Undefinable/compat/v33': pathRedirectionTo(`${UNDEFINABLE_DIR}/compat/v33`),
    'Undefinable/expect': pathRedirectionTo(`${UNDEFINABLE_DIR}/expect`),
    ...
    'Undefinable/unwrap': pathRedirectionTo(`${UNDEFINABLE_DIR}/unwrap`),
