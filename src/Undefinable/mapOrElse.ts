 ...
 */
export function mapOrElseForUndefinable<T, U>(src: Undefinable<T>, def: RecoveryFn<NotUndefined<U>>, selector: MapFn<NotUndefined<T>, NotUndefined<U>>): NotUndefined<U> {
    let r: NotUndefined<U>;
    let msg = '';
    if (src !== undefined) {
        r = selector(src);
