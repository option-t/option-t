 ...
 */
export function mapForMaybe<T, U>(src: Maybe<T>, selector: MapFn<NotNullAndUndefined<T>, NotNullAndUndefined<U>>): Maybe<U> {
    if (src !== undefined && src !== null) {
        const r: NotNullAndUndefined<U> = selector(src);
        // XXX:
