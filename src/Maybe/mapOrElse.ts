 ...
 */
export function mapOrElseForMaybe<T, U>(src: Maybe<T>, def: RecoveryFn<NotNullAndUndefined<U>>, selector: MapFn<NotNullAndUndefined<T>, NotNullAndUndefined<U>>): NotNullAndUndefined<U> {
