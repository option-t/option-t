...
- [`option-t/plain_option/namespace`](../packages/option-t/src/plain_option/namespace.ts) (We don't recommend to use this without TypeScript due to it would be hard to follow future breaking changes.)
...
- [`option-t/plain_option/unsafe/as_mut`](../packages/option-t/src/plain_option/unsafe/as_mut.ts)
- [`option-t/plain_option/unsafe/drop`](../packages/option-t/src/plain_option/unsafe/drop.ts)
