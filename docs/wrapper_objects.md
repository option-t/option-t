...
## [`Option<T>`](../src/ClassOption/ClassicOption.d.ts) (sometimes call `ClassOption` internally)
...
## [`Result<T, E>`](./src/ClassResult/ClassicResult.d.ts) (sometimes call `ClassResult` internally)
