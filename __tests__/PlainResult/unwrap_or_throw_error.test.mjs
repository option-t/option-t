...
import { unwrapOrThrowErrorFromResult } from '../../__dist/esm/PlainResult/unwrapOrThrowError.mjs';
...
test('input is Err, but the contained value is not Error', (t) => {
    ...
    const thrown = t.throws(
        ...
        },
        {
            ...
            message: `The contained E should be \`Error\` instance but that was \`${String(
                ERROR_E
            )}\``,
        }
    );
