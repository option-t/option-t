...
const { mapOrElseForNullable } = require('../../__dist/cjs/Nullable/mapOrElse');
...
for (const value of nonNullableValue) {
    test('pass the value: ' + String(value), (t) => {
        ...
        const result = mapOrElseForNullable(EXPECTED, () => DEFAULT_VAL, (v) => {
...
test('pass null', (t) => {
    ...
    const result = mapOrElseForNullable(null, () => DEFAULE_VAL, (_v) => {
...
test('pass undefined', (t) => {
    ...
    const result = mapOrElseForNullable(undefined, () => DEFAULE_VAL, (v) => {
        t.is(v, undefined);
        return COMPUTED_VAL;
    });
